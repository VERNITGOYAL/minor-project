  ...
  return (
    <section className="px-4 pb-10 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-4xl py-8 sm:py-12">
        ...
        <button type="button" className="mt-6 inline-flex items-center gap-2 rounded-md border border-[#dbe3e8] px-4 py-2 text-xs font-bold text-[#536477]" onClick={() => setProcessed(true)}><Check size={15} /> {processed ? "Ready for analysis" : "Mark as processed"}</button>
      </div>
    </section>
  );
}
